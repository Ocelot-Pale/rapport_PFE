...
\node[anchor=west] at (-6.5, -.25) {Niveau de résolution $j=3$};
\node[anchor=west] at (-6.5, .25) {Niveau de résolution $j=2$};
\node[anchor=west] at (-6.5, .75) {Niveau de résolution $j=1$};
% Niveau j-1
