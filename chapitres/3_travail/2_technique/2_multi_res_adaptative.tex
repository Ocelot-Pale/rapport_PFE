...
\subsubsection{Algorithmes de simulation numérique}
    ...
    \paragraph{Le cas volumes finis}
            ...
            Cela se fait à partir des valeurs de cellules de part et d'autres de la cellule.
...
\subsubsection{Implémentations de la multi-résolution}
    \paragraph{Méthodes usuelles}
            \subparagraph{Les approches \textit{patch-based}}
            \subparagraph{Les approches \textit{cell-based}}
    \paragraph{Le logiciel Samurai}
            \subparagraph{Un tructure de données originale}