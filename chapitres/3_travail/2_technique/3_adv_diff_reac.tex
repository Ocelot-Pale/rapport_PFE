...
\subsection{Les stratégies de simulation}
    ...
    \subsubsection{Les techniques d'intégration}
        ...
        \paragraph{Les méthodes ImEx}
            ...
            \footnote{Les méthdes évoquées ici sont les méthodes ImEx Runge et Kutta (RK-ImEx). Il existe également des méthodes ImEx couplées espace-temps\cite{rebou2024}.}
