...
Cette équation admet des solutions propagatives sous la forme\footnote{C'est une sigmoide, qui se propage à vitesse $\sqrt{\frac{kD}{2}}$.}:%AFAIRE --> AJOUTER UNE REFERENCE
\begin{align}
    \label{eq:sol_nagumo}
 u(x-ct) = \frac{e^{
...
\paragraph{Analyse des opérateurs}\label{par:analyser_operateurs_nagumo}
