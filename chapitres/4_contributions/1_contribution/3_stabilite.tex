...
Dans un premier temps, une étude générale de la stabilité de des RK-ImEx est ménée.
...
\subsubsection{Étude de stabilité générale des RK-ImEx}
    ...
    Cependant cela complique légèrement l'analyse usuelle de stabilié. En effet la fonction de stabilité attend alors deux varaibles, %AFAIRE -> ajouter les renvois vers la partie introduction à l'étude de stabilité etc...
    ...
    on ne peut plus visualiser d'un simple coup d'oeil le domaine de stabilité (comme en ... AFAIRE), puisque celui-ci est de dimension quatre
...
\subsubsection{Étude de stabilité appliquée à l'équation de Nagumo}
    ...
    \paragraph{Valeurs propres mises en jeu}
        ...
        \begin{itemize}
            ...
            \item[$\diamond$] La réaction dont le spectre balaie continuement $-k$ jusqu'à $2k$
        \end{itemize}
        Pour restreindre l'analyse de stabilié il faut donc tracer le diagramme de stabilité des méthodes étudiées en prenant $Z_I \in \mathbb{R}^-$ 
