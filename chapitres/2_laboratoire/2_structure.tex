...
\begin{itemize}
    ...
    \texttt{(II)} avec une multirésolution adaptative MRA \hlblue{\textit{sans reconstruction des flux}},
    \texttt{(III)} avec multirésolution adaptative \hlperu{\textit{avec reconstruction des flux au niveau le plus fin}}.
