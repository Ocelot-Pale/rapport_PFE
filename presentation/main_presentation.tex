...
\input{slides/10_ADR.tex}
\input{slides/11_ADR_ANALYSE.tex}
\input{slides/12_ADR_PRBLEMES.tex}
\input{slides/13_ADR_SOLUTIONS.tex}
\section{Objectifs}
\input{slides/20_CONTRIBUTIONS.tex}
