...
\newcommand{\reportsubtitle}{Rapport non-confidentiel}
...
\begin{titlepage}
    ...
    \begin{tabular}{ll}
        ...
        \textbf{Maîtres de stage:} & \supervisor \\
...
\chapter{Contributions}
    ...
    \section{Obtention de l'équation équivalente d'une méthode de lignes avec multirésolution adaptative sur un problème de diffusion.}
        ...
        \subsection{Cadre de l'étude}   
            \label{par:contrib_2:cadre}
            \input{chapitres/4_contributions/2_contribution/1_cadre.tex}
        \subsection{Les équations équivalentes}
            \label{par:contrib_2:resultats}
            \input{chapitres/4_contributions/2_contribution/2_eq_equiv.tex}
        \newpage
        \subsection{Complément expérimental}
            \label{par:contrib_2:exp}
            \input{chapitres/4_contributions/2_contribution/3_experimental.tex}
        \subsection{Conclusion}
            \input{chapitres/4_contributions/2_contribution/4_conclusion.tex}
    ...
    \section{Impact de la qualité de reconstruction des flux pour les problèmes diffusion avec AMR.}
        ...
        \newpage
        \subsection{Conclusion}
            \input{chapitres/4_contributions/3_contribution/6_conclusion.tex}
\chapter{Conclusion}
