...
\chapter{Contribution}
    ...
    \section{Étude de mathodes ImEx sur une équation de diffusion-réaciton}
        ...
        \subsection{L'équation de Nagumo}
            \input{chapitres/4_contributions/1_contribution/1_nagumo.tex}
        \newpage
        \subsection{Les méthodes ImEx}
            \input{chapitres/4_contributions/1_contribution/2_imex.tex}
        \newpage
        \subsection{Analyse de stabilité}
            \input{chapitres/4_contributions/1_contribution/3_stabilite.tex}
        \subsection{Étude de la convergence}
            \input{chapitres/4_contributions/1_contribution/4_convergence.tex}
        \subsection{Conclusion}
            \input{chapitres/4_contributions/1_contribution/5_conclusion.tex}
    % Travail 1 
        % Réalisaiton
        % conclusion
    % Travail 2
